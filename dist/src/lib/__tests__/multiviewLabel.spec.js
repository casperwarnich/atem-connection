...
const multiviewLabel_1 = require("../multiviewLabel");
const freetype2_1 = require("@julusian/freetype2");
const fs = require("fs");
describe('Multiview Label', () => {
    const font = (0, freetype2_1.NewMemoryFace)(fs.readFileSync(__dirname + '/../../../assets/roboto/Roboto-Regular.ttf'));
    test('null', () => {
        const result = (0, multiviewLabel_1.calculateGenerateMultiviewerLabelProps)(null);
    ...
    test('1ME', () => {
        ...
        const result = (0, multiviewLabel_1.calculateGenerateMultiviewerLabelProps)({ info });
        ...
        const buffer = (0, multiviewLabel_1.generateMultiviewerLabel)(font, 1, '', result);
...
//# sourceMappingURL=multiviewLabel.spec.js.map