...
exports.CameraControlWhitebalanceCommand = exports.CameraControlAutoFocusCommand = exports.CameraControlFocusCommand = exports.CameraControlPTZCommand = exports.CameraControlZoomCommand = exports.CameraControlGainCommand = exports.CameraControlGainLegacyCommand = exports.CameraControlIrisCommand = void 0;
const CommandBase_1 = require("../CommandBase");
class CameraControlIrisCommand extends CommandBase_1.BasicWritableCommand {
    constructor(cameraId, percent) {
...
exports.CameraControlIrisCommand = CameraControlIrisCommand;
CameraControlIrisCommand.rawName = 'CCmd';
class CameraControlGainLegacyCommand extends CommandBase_1.BasicWritableCommand {
    constructor(cameraId, value) {
...
exports.CameraControlGainLegacyCommand = CameraControlGainLegacyCommand;
CameraControlGainLegacyCommand.rawName = 'CCmd';
class CameraControlGainCommand extends CommandBase_1.BasicWritableCommand {
    constructor(cameraId, gainDb) {
...
exports.CameraControlGainCommand = CameraControlGainCommand;
CameraControlGainCommand.rawName = 'CCmd';
class CameraControlZoomCommand extends CommandBase_1.BasicWritableCommand {
    constructor(cameraId, speed) {
...
exports.CameraControlZoomCommand = CameraControlZoomCommand;
CameraControlZoomCommand.rawName = 'CCmd';
class CameraControlPTZCommand extends CommandBase_1.BasicWritableCommand {
    constructor(cameraId, panSpeed, tiltSpeed) {
...
exports.CameraControlPTZCommand = CameraControlPTZCommand;
CameraControlPTZCommand.rawName = 'CCmd';
class CameraControlFocusCommand extends CommandBase_1.BasicWritableCommand {
    constructor(cameraId, increment) {
...
exports.CameraControlFocusCommand = CameraControlFocusCommand;
CameraControlFocusCommand.rawName = 'CCmd';
class CameraControlAutoFocusCommand extends CommandBase_1.BasicWritableCommand {
...
exports.CameraControlAutoFocusCommand = CameraControlAutoFocusCommand;
CameraControlAutoFocusCommand.rawName = 'CCmd';
class CameraControlWhitebalanceCommand extends CommandBase_1.BasicWritableCommand {
    constructor(cameraId, kelvin) {
...
exports.CameraControlWhitebalanceCommand = CameraControlWhitebalanceCommand;
CameraControlWhitebalanceCommand.rawName = 'CCmd';
...
//# sourceMappingURL=CameraControlPropertiesCommand.js.map